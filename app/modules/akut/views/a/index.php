...
$this->title = Yii::t('app', 'Förfrågningar');
...
<?php if($data->count > 0) : ?>
        ...
        <thead>
            <tr>
                <?php if(IS_ROOT) : ?>
                    <th width="50">#</th>
                <?php endif; ?>
                <th><?= Yii::t('app', $this->context->module->settings['enableTitle'] ? 'Title' : 'Text') ?></th>
                <th width="150"><?= Yii::t('app', 'Date') ?></th>
                <th width="100"><?= Yii::t('akut', 'Answer') ?></th>
                <th width="30"></th>
            </tr>
        </thead>
        <tbody>
    <?php foreach($data->models as $item) : ?>
            <tr>
                ...
                <td>
                    <?php if($item->status == Akut::STATUS_ANSWERED) : ?>
...
<?php else : ?>
    <p><?= Yii::t('akut', 'No records found') ?></p>
<?php endif; ?>