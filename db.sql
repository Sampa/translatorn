...
--
-- Table structure for table `app_sidas`
--

CREATE TABLE `app_sidas` (
...
(1, 'Index', '<p>Text på indexsidan</p>', 'page-index'),
(13, 'Akut tolk', '<p>Text på tolksida...</p>', 'page-akut'),
(2, 'Shop', '', 'page-shop'),
...
(42, '', 'aou', '', 0, NULL, NULL, NULL, 2147483647, 3, 1, '03/05', 'Customer', '839 03/05 aou', '', '2147483647', '1351351351351', '', 'daniel_golfare@hotmail.com', '', 'test@test.se', 'AdvokatByrå aB', '23:15:00', '23:15:00'),
...
(1, 'root', 'idrini@gmail.com', '$2y$10$S1bKrtb5OJKnwyDG/5kzuu5cpWEptjfUTyfHTDf4SPcs0uoQFB2z.', 'HMr5eam_HS2mgfZk0I9cg-UO8tTJXDtX', 1494252329, NULL, NULL, '127.0.0.1', 1494252309, 1494456830, 0, 1494618540, '', 0),
(2, 'manager', 'nillithion@hotmail.com', '$2y$10$HCy.joCSL69T47ESB9BVIOwLNl0lP3xsMkJ15pvAapYgRNTafxvfC', 'PTh3Rvh55uOOAMJGIiWF-8iN-RSY_C_0', 1494254345, NULL, NULL, '127.0.0.1', 1494254345, 1494254345, 0, 1494840436, '0', 0),
(3, 'Customer', 'daniel_golfare@hotmail.com', '$2y$10$O78qkzJntCoNazhxqJb6p.S2MFW.Kdpe49UmzVplYnAWV1DZlBCj6', 'MAayXrfjD5cwCnLfcX_8SHSyqQ1qgRRI', 1494262131, NULL, NULL, '::1', 1494262131, 1494455468, 0, 1494795810, '1', 0),
...
--
ALTER TABLE `easyii_texts`
  MODIFY `text_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
